...
lexicon(drive, [synt:v, vwp:g, im:drive, dur:2.5|_]).

lexicon(circle, [synt:v, vwp:f, im:circle, dur:0.5|_]).
lexicon(draw, [synt:v, vwp:f, im:draw_a_circle, dur:1|_]).
lexicon(draw, [synt:vp, vwp:g, im:drawing, dur:2|_]).
lexicon(sneeze, [synt:vp, vwp:f, im:sneeze, dur:0|_]).
lexicon(sleep, [synt:vp, vwp:g, im:sleep, dur:4.5|_]).
lexicon(jump, [synt:vp, vwp:f, im:jump, dur:0|_]).
lexicon(fly, [synt:vp, vwp:g, im:fly, dur:3|_]).
