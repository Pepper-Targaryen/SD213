...
vp(FV,PVP,TVP) --> v(FV,PV,TV), pp(FPP1,PPP1,TPP1), pp(FPP2,PPP2,TPP2), { % verbs that take two prepositional complements
...
n([gloss:daughter, num:single],daughter(_,_),n(daughter)) --> [daughter].
...
pn([gloss:lisa, num:sing], lisa, pn(lisa)) --> ['Lisa'].
